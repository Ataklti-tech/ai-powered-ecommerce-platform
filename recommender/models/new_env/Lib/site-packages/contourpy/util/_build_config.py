...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"C:/Users/hp/Desktop/e_commerce/recommender/models/new_env/python.exe",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"C:/miniconda3/conda-bld/contourpy_1763643943275/work/.mesonpy-6yl2x1nz/lib/contourpy/util",
        source_dir=r"C:/miniconda3/conda-bld/contourpy_1763643943275/work/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True '--native-file=C:/miniconda3/conda-bld/contourpy_1763643943275/work/.mesonpy-6yl2x1nz/meson-python-native-file.ini'",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
