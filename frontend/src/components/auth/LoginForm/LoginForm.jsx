...
import { mergeCartAsync } from '../../../features/cart/cartSlice';
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Handle the backend response structure: { status, token, data: { user } }
      ...
      // Merge local guest cart into DB, then load wishlist
      dispatch(mergeCartAsync(localCartItems));
